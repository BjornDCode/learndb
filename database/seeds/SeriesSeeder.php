...
class SeriesSeeder extends Seeder
{
    ...
    public function run()
    {
        factory(Series::class)->create([
            ...
            'image' => '/storage/series_images/database-normalisation.png',
        ]);
        ...
        factory(Series::class)->create([
            ...
            'image' => '/storage/series_images/er-diagrams.png',
        ]);
        ...
        factory(Series::class)->create([
            ...
            'image' => '/storage/series_images/postgresql.png',
        ]);
        ...
        factory(Series::class)->create([
            ...
            'image' => '/storage/series_images/php-and-databases.png',
        ]);
        ...
        factory(Series::class)->create([
            ...
            'image' => '/storage/series_images/relational-databases.png',
        ]);
        ...
        factory(Series::class)->create([
            ...
            'image' => '/storage/series_images/sql.png',
        ]);
    }
}
